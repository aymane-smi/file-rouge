...
export const CartInfo:FC<cardInfo> = ({numberOf, description})=>{
    return (<div className="p-4 w-[300px] rounded-md border border-black flex justify-between items-center">
